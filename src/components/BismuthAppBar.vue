...
export default class BismuthAppBar extends Vue {
  ...
  get projectFromStore(): ProjectPOTO {
    return this.$store.state.project.selectedProject;
  }

  @Watch("projectFromStore")
  onProjectFromStoreChange(newProject: ProjectPOTO | undefined, oldProject: ProjectPOTO | undefined) {
    if (newProject == undefined) {
      this.projectDropdownTitle = "Select a project";
    } else {
      this.projectDropdownTitle = newProject.name;
    }
  }
  ...
  onSelectedProjectChange(
    ...
    if (undefined == newProject) {
      this.projectDropdownTitle = "Select a project";
      this.$store.dispatch("project/setSelectedProject", undefined);
    ...
    this.$store.dispatch("project/setSelectedProject", selectedProject);
